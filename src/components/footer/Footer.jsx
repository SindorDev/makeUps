              ...
              <Container>
                     <div className="flex items-start justify-between">
                            ...
                            <div className="flex flex-col gap-2 text-start">
                                   ...
                                   <span className="text-[15px] font-normal">Website Terms of Use</span>
                            ...
                            <div className="w-full max-w-[300px] flex flex-col gap-2">
                                    <h3 className="text-[16px] font-medium">Want More from Beauty Bay?</h3>
                                    ...
                                    <div className="flex items-center border-b-2 border-black gap-5">
                                          <input type="email" className="bg-transparent text-black text-[16px] capitalize font-medium py-2 outline-none w-full" placeholder="Your Email" />
                                          <AiOutlineArrowRight size={40} />
                                    </div>
                                    <div className="flex items-center gap-5 mt-5">
                                          <BsFacebook size={40} /><BsInstagram size={40} /><FaTwitterSquare size={40} /><FaTiktok size={40} /><FaPinterest size={40} /><BsYoutube size={40} />
                                    </div>
                            </div>
                     </div>
              </Container>
